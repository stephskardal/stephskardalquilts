...
var quiltPlay = {
  ...
  init: function() {
    $('#randomSize, #sliderRows,#sliderCols,#currentUnits,#sliderBorder').slider({}); 
  ...
  drawHovers: function(svg, units, halfSize, startingX, startingY, row, col) {
    ...
    //TODO: Change to enter all at once 
    //console.log(yoyo);
    //var merged = [].concat.apply([], yoyo);
    //svg.selectAll('polygon')
    //  .data(merged)
    //  .enter().append('polygon')
    //  .attr('points', function(d) { console.log(d); return d; });
