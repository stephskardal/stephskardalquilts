...
jQuery(document).on('ready', function() {
  ...
  //buildSecondary('septenaryColors', 'octonaryColors', 'With Octonary Colors'); 
  //buildSecondary('octonaryColors', 'nonaryColors', 'With Nonary Colors'); 
  //buildSecondary('nonaryColors', 'denaryColors', 'With Denary Colors'); 
