      ...
      <Box sx={{ flexGrow: 1, marginTop: '0px' }}>
        <Grid container spacing={3}>
          ...
          <Grid item sm={7} xs={12}>
            ...
            <Typography align="left" sx={{ marginBottom: '20px' }}>
              Hi, I’m Steph! I sew things. Lately more often than not, those
              things have been quilts. And somehow you’ve come to my website and
              landed on my about page, so I’ll tell you a little bit more about
              me.
            </Typography>
            <Typography align="left" sx={{ marginBottom: '20px' }}>
              I currently live outside of Columbus, Ohio with my family of a
              wicked cool (his words) husband, three young daughters, and a
              rambunctious golden retriever. I work as a software engineer and
              have been in this industry for about 14 years. Sometimes, my
              interest in technology finds it’s way into my quilting influence.
              Outside of quilting, I enjoy running and other outdoor activities.
              I dabble in other fiber arts as well, but most often my time is
              spent experimenting and pushing boundaries in the quilting space!
            </Typography>
            <Typography align="left" sx={{ marginBottom: '40px' }}>
              Here’s a peak into my quilting journey, in timeline form:
            </Typography>
          </Grid>
        </Grid>
        <Box sx={{ mt: '20px' }}>
